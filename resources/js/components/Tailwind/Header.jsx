                ...
                <div className="bg-primary text-white text-xs md:text-sm py-2 md:py-3">
                    <div className="px-[5%] mx-auto flex flex-row items-center justify-center md:justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center gap-2 md:justify-start md:gap-4">
                            <a
                                href={`mailto:${ContactEmail?.description}`}
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M1 3L4.45651 4.96231C5.71935 5.67925 6.28065 5.67925 7.5435 4.96231L11 3"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M5.25 10.25C5.01685 10.247 4.78341 10.2425 4.54942 10.2366C2.97517 10.197 2.18804 10.1772 1.62248 9.6092C1.05692 9.04115 1.04057 8.27435 1.00789 6.7407C0.997375 6.24755 0.99737 5.75735 1.00788 5.26421C1.04057 3.73056 1.05691 2.96374 1.62248 2.39569C2.18804 1.82765 2.97516 1.80786 4.54941 1.76829C5.51965 1.7439 6.48035 1.74391 7.4506 1.7683C9.02485 1.80787 9.81195 1.82766 10.3775 2.3957C10.9431 2.96374 10.9594 3.73057 10.9921 5.26422C10.9969 5.49126 10.9996 5.59825 11 5.75"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M9.5 9C9.5 9.4142 9.1642 9.75 8.75 9.75C8.3358 9.75 8 9.4142 8 9C8 8.5858 8.3358 8.25 8.75 8.25C9.1642 8.25 9.5 8.5858 9.5 9ZM9.5 9V9.25C9.5 9.6642 9.8358 10 10.25 10C10.6642 10 11 9.6642 11 9.25V9C11 7.75735 9.99265 6.75 8.75 6.75C7.50735 6.75 6.5 7.75735 6.5 9C6.5 10.2427 7.50735 11.25 8.75 11.25"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                            ...
                            <a
                                href={`tel:${ContactNumber?.description}`}
                                className="flex items-center  space-x-1"
                            >
                                <svg
                                    width="14"
                                ...
                                >
                                    <path
                                        d="M9.52415 8.7461C10.127 8.17025 10.5 7.37475 10.5 6.4961C10.5 5.6174 10.127 4.82192 9.52415 4.24609M8.5 5.37109C8.80145 5.659 8.98795 6.05675 8.98795 6.4961C8.98795 6.93545 8.80145 7.3332 8.5 7.6211"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M8 4C8 2.82149 8 2.23223 7.6339 1.86611C7.26775 1.5 6.6785 1.5 5.5 1.5H4C2.82149 1.5 2.23223 1.5 1.86611 1.86611C1.5 2.23223 1.5 2.82149 1.5 4V9C1.5 10.1785 1.5 10.7677 1.86611 11.1339C2.23223 11.5 2.82149 11.5 4 11.5H5.5C6.6785 11.5 7.26775 11.5 7.6339 11.1339C8 10.7677 8 10.1785 8 9"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    />
                                    <path
                                        d="M5.75 1.5H3.75L4 2H5.5L5.75 1.5Z"
                                        stroke="white"
                                        strokeWidth="0.75"
                                        strokeLinecap="round"
                                        strokeLinejoin="round"
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                                d="M0 6.5C0 3.18629 2.68629 0.5 6 0.5C9.31371 0.5 12 3.18629 12 6.5C12 9.81371 9.31371 12.5 6 12.5C2.68629 12.5 0 9.81371 0 6.5ZM3.075 5.4875V9.5H4.35V5.4875H3.075ZM3 4.2125C3 4.625 3.3 4.925 3.7125 4.925C4.125 4.925 4.425 4.625 4.425 4.2125C4.425 3.8 4.125 3.5 3.7125 3.5C3.3375 3.5 3 3.8 3 4.2125ZM7.725 9.5H8.925V7.025C8.925 5.7875 8.175 5.375 7.4625 5.375C6.825 5.375 6.375 5.7875 6.2625 6.05V5.4875H5.0625V9.5H6.3375V7.3625C6.3375 6.8 6.7125 6.5 7.0875 6.5C7.4625 6.5 7.725 6.6875 7.725 7.325V9.5Z"
                                                fill="white"
                                            />
                                        </svg>
                                        LinkedIn
                            ...
                            {YouTube && (
                                <>
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                d="M6.975 6.5L5.4 5.6V7.4L6.975 6.5Z"
                                                fill="white"
                                            />
                                            <path
                                                fillRule="evenodd"
                                                clipRule="evenodd"
                                                d="M0 6.5C0 3.18629 2.68629 0.5 6 0.5C9.31371 0.5 12 3.18629 12 6.5C12 9.81371 9.31371 12.5 6 12.5C2.68629 12.5 0 9.81371 0 6.5ZM8.325 4.5125C8.58751 4.5875 8.775 4.775 8.85 5.0375C9 5.525 9 6.5 9 6.5C9 6.5 9 7.475 8.8875 7.9625C8.8125 8.225 8.625 8.4125 8.3625 8.4875C7.875 8.6 6 8.6 6 8.6C6 8.6 4.0875 8.6 3.6375 8.4875C3.375 8.4125 3.1875 8.225 3.1125 7.9625C3 7.475 3 6.5 3 6.5C3 6.5 3 5.525 3.075 5.0375C3.15 4.775 3.3375 4.5875 3.6 4.5125C4.0875 4.4 5.9625 4.4 5.9625 4.4C5.9625 4.4 7.875 4.4 8.325 4.5125Z"
                                                fill="white"
                                            />
                                        </svg>
                                        YouTube
                    ...
                    >
                        ...
                        >
                            <nav className="flex gap-2">
                                {[
                                    "/nosotros",
                                    lenghtServices > 0 ? "#services" : null,
                                    lenghtCasos > 0 ? "/casos-de-exito" : null,
                                    "/blog",
                                    "/infoproductos",
                                    "/contacto",
                                ]
