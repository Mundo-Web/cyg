...
const TermsAndConditions = ({ generals }) => {
    const { t } = useTranslation();
    const content = generals?.find((x) => x.correlative === "terms_conditions")?.description ?? "";
                ...
                <section className="px-[5%] py-12 lg:py-20 max-w-5xl mx-auto">
                    <div className="mb-10 text-center">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-4">
                            {t("public.form.terms", "Términos y condiciones")}
                        </h1>
