...
Route::get('/politicas-de-privacidad', [LegalController::class, 'privacyPolicy'])->name('PrivacyPolicy.jsx');
Route::get('/terminos-y-condiciones', [LegalController::class, 'termsAndConditions'])->name('TermsAndConditions.jsx');
Route::get('/politicas-de-cambio', [LegalController::class, 'exchangePolicy'])->name('ExchangePolicy.jsx');
